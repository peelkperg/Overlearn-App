...
describe('lib/history [Story 2.7]', () => {
  ...
  it('writes and reads back a history entry', () => {
    const entry = { date: '2026-08-31T12:00:00.000Z', finalTarget: 6, totalMistakes: 11, totalAttempts: 17 };
  ...
  it('keeps history separate per segment', () => {
    const entryA = { date: '2026-08-31T12:00:00.000Z', finalTarget: 5, totalMistakes: 0, totalAttempts: 5 };
    const entryB = { date: '2026-08-31T13:00:00.000Z', finalTarget: 5, totalMistakes: 2, totalAttempts: 7 };
