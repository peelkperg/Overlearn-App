...
**Interim solution (2026-09-16):** a free Bitly branded short link (e.g. `bit.ly/overlearn-app`) pointing at the Google Sites landing page — zero cost, no code/DNS change. Chosen over TinyURL for Bitly's better long-term reliability/uptime track record and free custom-back-half support.
